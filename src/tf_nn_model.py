...
#%%
train_dataset = tf.data.Dataset.from_tensor_slices((xtrain, ytrain.cat.codes.values)).batch(32)
val_dataset = tf.data.Dataset.from_tensor_slices((xval, yval.cat.codes.values)).batch(32)
